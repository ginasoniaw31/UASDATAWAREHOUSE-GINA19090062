...
<html>
  <head>
    ...
    <title>SPK TOPSIS DISCOUNT CUSTOMER </title>
    <!--bootstrap-->
    ...
    <nav class="navbar navbar-default navbar-custom navbar-dark bg-dark" style='background-color:black;'>
      <div class="container"> 
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SPK Metode Topsis Discount untuk customer msglow</a>
        </div>
    ...
    <footer class="text-center">
      <div class="footer-below">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <em>Copyright &copy; Gina Sonia W _19090062</em>
            </div>
          </div>
        </div>
      </div>
